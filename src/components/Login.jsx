...
const LoginForm = () => {
  ...
  return (
    <div className="bg-gray-900 h-screen flex items-center justify-center text-white">
      <form className="max-w-md mx-auto" style={{ width: '20%' }}>
        <div className="mb-5">
          ...
          <div className="relative">
            ...
            >
              {showPassword ? (
                ...
                >
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 12a3 3 0 11-6 0 3 3 0 016 0z" />
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M10 15a7.5 7.5 0 005 2.598M9 9a7.5 7.5 0 00-5 2.598" />
                </svg>
              )}
            </button>
          </div>
        ...
        <div className="flex justify-center mt-5 mb-3">
          <Link to="/signup" className="text-sm font-medium text-gray-900 dark:text-gray-300">
            Create Account?
          </Link>
        </div>
      </form>
