          ...
          <div className="grid md:grid-cols-2">
            <div className="waiting-left-side ">
              <div className="waiting-left p-10 mt-10">
                <h1 className="text-6xl font-bold text-gray-900">What Are You Waiting For?</h1>
                ...
                <button className="rounded-md hover:bg-black hover:text-white bg-gray-900 font-bold text-white px-10 py-5">Contact Us</button>
              </div>
            </div>
              ...
              <div class="py-8 lg:py-16 px-4 mx-auto max-w-screen-md">
                <form action="#" class="space-y-8">
                  <div>
                    ...
                    <input type="email" id="email" class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500 dark:shadow-sm-light" placeholder="kathrynbernardo@gmail.com" required />
                  </div>
                  <div>
